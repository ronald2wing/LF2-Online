                  ...
                  if (target.uid != self.uid) {
                    if (
                      ...
                      if (self.data.frame[251]) {
                        const ITR = coreUtil.arrayWrap(self.data.frame[251].itr)[0]
                        const vol = self.mech.volume(coreUtil.arrayWrap(self.data.frame[251].itr)[0])
                        if (target.attacked(
                          target.hit(ITR, self, { x: self.ps.x, y: self.ps.y, z: self.ps.z }, vol)
                        )) {
