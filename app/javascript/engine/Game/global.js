...
// -- Background colours --
// Known packed 15-bit background colours and their exact CSS rendering. These
// are stages whose packed value cannot be reproduced by the bit-shift fallback
// in decodeColor() (background.js), so the hand-tuned colour is looked up here
// by the packed integer before falling back to unpacking.
G.background = {}
G.background.colors = {
  4706:  'rgb(16,79,16)',     // lion forest
  40179: 'rgb(159,163,159)', // HK Coliseum
  29582: 'rgb(119,119,119)',
  37773: 'rgb(151,119,111)',
  33580: 'rgb(135,107,103)',
  25356: 'rgb(103,103,103)',
  21096: 'rgb(90,78,75)',    // Stanley Prison
  37770: 'rgb(154,110,90)',  // The Great Wall
  16835: 'rgb(66,56,24)',    // Queen's Island
  34816: 'rgb(143,7,7)',     // Forbidden Tower
}

// -- Network defaults --
// Official lobby advertised in the server list, shared by the manager's default
// settings and the network-game UI. Spread into a fresh object at each use so
// neither site mutates this constant.
G.network = {}
G.network.lobbyServers = {
