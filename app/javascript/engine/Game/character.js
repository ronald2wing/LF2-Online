 ...
 */
  ...
  post_interaction() {
    ...
    // NOTE: original LF2 picks one itr when several overlap a target — the
    // first itr in the frame wins, except that two itrs with the same effect
    // and overlapping range pick an effect at random within the overlap.
    // This port applies each matching itr in turn instead.
