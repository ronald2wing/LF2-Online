...
import { show, hide, createTextBox, HorizontalNumberDialog } from "engine/Game/manager-dialogs"
...
class GameManager {
  ...
  this.switch_UI = function (page) {
    ...
    domQuery.queryUI('window').style.background = this.UI_list[page].bgcolor || ''
    if (window_state.maximized) {
