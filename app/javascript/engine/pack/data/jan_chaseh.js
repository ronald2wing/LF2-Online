export default {
  bmp: {
    file: [
      {
        "file(0-11)": "sprite/jan_chaseh.png", w: 81, h: 82, row: 4, col: 3
      }
    ],
  ...
  20: { name: "hit",
    pic: 0, state: 3002, wait: 1, next: 21, dvx: 0, dvy: 0, dvz: 0, centerx: 55, centery: 40, hit_a: 0, hit_d: 0, hit_j: 0
  },
  21: { name: "hit",
    pic: 0, state: 3002, wait: 1, next: 22, dvx: 0, dvy: 0, dvz: 0, centerx: 52, centery: 40, hit_a: 0, hit_d: 0, hit_j: 0
  },
  22: { name: "hit",
    pic: 0, state: 3002, wait: 1, next: 23, dvx: 0, dvy: 0, dvz: 0, centerx: 55, centery: 40, hit_a: 0, hit_d: 0, hit_j: 0
  },
  23: { name: "hit",
    pic: 0, state: 3002, wait: 1, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 58, centery: 41, hit_a: 0, hit_d: 0, hit_j: 0
  },
  30: { name: "rebounding",
  ...
  50: { name: "start",
    pic: 0, state: 3005, wait: 1, next: 51, dvx: 0, dvy: 0, dvz: 0, centerx: 45, centery: 38, hit_a: 0, hit_d: 0, hit_j: 0
  },
  51: { name: "start",
    pic: 0, state: 3005, wait: 1, next: 52, dvx: 0, dvy: 0, dvz: 0, centerx: 45, centery: 38, hit_a: 0, hit_d: 0, hit_j: 0, hit_Fa: 5
  },
  52: { name: "start",
    pic: 0, state: 3005, wait: 1, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 45, centery: 38, hit_a: 0, hit_d: 0, hit_j: 0
  },
  60: { name: "star",
