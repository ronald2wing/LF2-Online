...
export default {
  object: [
    ...
    // Template (id 0) IS a real selectable character in the original: the
    // official control.txt documents him ("==Template== No special moves."),
    // the readme names him, and the shipped data.txt lists him first. He is
    // deliberately weak — the recommended practice character — and he is the
    // starting point for homemade characters. He does not appear in Stage or
    // Survival mode.
    ...
    // ── Drinks (drunk in state 17; recover HP/MP over time) ──
  ...
  background: [
    ...
    // The "Template1" example background stays out of the roster: unlike the
    // Template *character*, the template backgrounds are authoring examples
    // (they display their own layer filenames) and no source shows them
    // enabled in the shipped data.txt.
