...
// weapon-rest.test.js and weapon-swing-team.test.js.
...
globalThis.Image = class Image {
  constructor() { this.naturalWidth = 58; this.naturalHeight = 58 }
...
// A target body that fills the whole arena, so it always overlaps the thrown
// weapon's itr volume. `hit` records how many times the throw reached it.
...
function throwHits({ team, type, state }) {
  ...
  const weapon = new HeavyWeapon({ match: makeMatch(scene), team: TEAM }, heavyData, WEAPON_ID)
