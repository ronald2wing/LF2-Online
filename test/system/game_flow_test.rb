...
class GameFlowTest < ApplicationSystemTestCase
  ...
  test "typing lf2.net then navigating past the base roster does not crash" do
    ...
    # at startup from the base 11-hero roster. Toggling lf2.net must re-snapshot
    # it so the 24 unlocked fighters have portraits (otherwise the game throws a
    # TypeError the moment selection steps past the 12th fighter).
