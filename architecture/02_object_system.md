...
> Source: original LF2 v2.0a `.dat` files, engine entity system in `living-object.js`, `global.js`
...
| ATTACK | 3 | Attack | Normal/special attack frames (weapon attack also uses this) |
| JUMP | 4 | Jump | In air from jump |
| DASH | 5 | Dash | Aerial dash |
| ROWING | 6 | Rowing | Recovery roll / dash attack |
| DEFEND | 7 | Defend | Guarding |
| BROKEN_DEFEND | 8 | Broken Defend | Guard broken |
| CATCHING | 9 | Catching | Holding another character |
| BEING_CAUGHT | 10 | Caught | Being held |
| INJURED | 11 | Injured 1 | Hit and recoiling |
| FALLING | 12 | Falling | Knocked airborne/tumbling |
| FROZEN | 13 | Ice | Frozen solid |
| LYING | 14 | Lying | Knocked down on ground |
| CROUCH | 15 | Transitional | Crouch, throw, weapon pickup, teleport prep, charge |
...
| — | 3004 | Disappearing | Projectile fade-out animation |
| — | 3005 | Flying (No Shadow) | Ball flying without shadow; destroys other balls, only destroyed by another 3005 |
| — | 3006 | Flying (Arrow) | Arrow-class projectile; destroyed only by 3005/3006, reflected only by shield (kind 9) |
...
```
objects[  0 -   7]: Players (8 slots)
objects[  8 -   9]: Reserved
