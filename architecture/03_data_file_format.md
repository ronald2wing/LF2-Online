...
Objects with IDs 100–199 can drop from the sky in **VS mode** — automatically during a match, or on the F8 key (F8 is disabled in stage mode).
...
| `facing` | 0 = same direction as parent; 1 = opposite; 2–10 = right; 11–19 = left; multi-spawn when abs(facing) > 10 |
