...
7. Validate hits with team, invincibility, and immunity rules
...
- **Z**: Depth (positive = toward the viewer / foreground)
- Units: pixels
...
| Drink | 6 | Milk/beer — drunk in state 17, recovers over time |
